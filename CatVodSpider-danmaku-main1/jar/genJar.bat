...
rd /s/q "%~dp0\spider.jar\smali\com\google\zxing"
...
if not exist "%~dp0\spider.jar\smali\com\google\" md "%~dp0\spider.jar\smali\com\google\"
...
if exist "%~dp0\Smali_classes\smali_classes2\com\google\zxing" move "%~dp0\Smali_classes\smali_classes2\com\google\zxing" "%~dp0\spider.jar\smali\com\google\"
if exist "%~dp0\Smali_classes\smali\com\google\zxing" move "%~dp0\Smali_classes\smali\com\google\zxing" "%~dp0\spider.jar\smali\com\google\"
